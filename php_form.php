...
$nameErr = $emailErr = $genderErr = $websiteErr = $nicknameErr="";
...
<form method="post" action="php_form_results.php">
	<table>
			<tr> 
				<td> Nickname: </td> 
				<td> <input type = "text" name ="nickname" size = "30" required /></td>
		<td> <span class="error"> * <?php echo $nicknameErr; ?> </span> </td>
		   </tr>
	</table>
